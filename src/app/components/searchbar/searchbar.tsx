...
export const Searchbar: React.FC = () => {
	const { matchedProducts, handleChange, opened, openSearchList, closeSearchList, inputRef, isLoading, hasShowMore } =
		useSearchbar();
	...
	return (
		<div className="pt-4 md:pt-0 px-4">
			<label className="flex border rounded-md transition-colors duration-100 items-center has-[:focus-within]:border-gray-500 cursor-pointer">
				<input
					ref={inputRef}
					className="w-full p-2 outline-none border-none rounded-md"
					type="text"
					placeholder="Search"
